...
ALLOWED_HOSTS = ["sharpshort.herokuapp.com"]

# Get database name/user from environmental variables
DB_NAME = os.environ.get("POSTGRES_DB", "sharpshort_default")
DB_USER_NAME = os.environ.get("POSTGRES_USER", "sharpshort_default_user")
